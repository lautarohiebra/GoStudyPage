  ...
  return (
    <div className="navbar bg-base-100 text-neutral px-1 lg:px-8 fixed z-50 shadow-md h-20">
          ...
          <div className="drawer-side">
            ...
            <ul className="menu bg-base-100 w-72 max-w-96 min-h-full rounded-none overflow-hidden z-50">
              ...
              <li>
                <details>
                  ...
                  <ul className="transition-all">
                    <div className="mt-3 h-8 flex align-middle justify-center text-primary text-sm items-center w-full">
              ...
              <div className="w-full">
                ...
                <Link to={"/contact"}>
                  <button className="btn btn-outline mt-3 btn-block">
                    Contacto
                  </button>
                </Link>
              </div>
        ...
        <ul className="menu menu-horizontal px-1">
          <li tabIndex={0}>
            <details>
              ...
              <ul className="p-2 flex flex-col bg-base-100 text-black font-medium">
                <span className="p-3 text-primary underline underline-offset-4">
          ...
          <li tabIndex={0}>
            <details>
              ...
              <ul className="p-2 flex flex-col bg-base-100 text-black font-medium">
                ...
                <div className="divider m-0"></div>
                <Link to={"/destinations"}>
                  <li className="btn btn-primary btn-sm font-semibold text-center text-white transition-all hover:shadow-md hover:-translate-y-1">
                    Todos los destinos
                  </li>
                </Link>
              </ul>
      ...
      <div className="navbar-end">
        <Link to={"/contact"}>
          <button className="btn btn-primary btn-outline">Contactanos</button>
        </Link>
      </div>
    </div>
  );
