    ...
    <div className="z-40">
      <footer className="footer py-10 px-32 items-center justify-around lg:items-start flex flex-col lg:flex-row bg-secondary text-white">
        ...
        <div className="flex flex-col justify-center items-center lg:items-start">
          ...
          <Link to={"/about"} className="link link-hover text-center">
            Sobre nosotros
          </Link>
        ...
        <div className="flex flex-col justify-center items-center lg:items-start">
          ...
          <div className="grid grid-flow-col gap-4">
            <Link
              target="blank"
              to={"https://www.instagram.com/gostudyargentina/"}
            >
              <img
            ...
            <Link
              target="blank"
              to={"https://www.facebook.com/GoStudyArgentina/"}
            >
              <img
